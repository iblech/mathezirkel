...
\usepackage{geometry}
\geometry{tmargin=2.5cm,bmargin=4cm,lmargin=3.5cm,rmargin=3.5cm}
...
24~Mitarbeiterinnen und Mitarbeiter ehrenamtlich die knapp
...
Sommerferien 2014 veranstalteten wir mit 88~Teilnehmenden erstmalig ein fünftägiges Mathecamp.
Im August~2015 wird es das Mathecamp wieder geben, dann sieben statt fünf Tage
lang.
...
\begin{tabular}{@{}p{4.0cm}@{\qquad}p{6cm}@{\qquad}l@{}}
  ...
  Ralph Lettau & Diplom in Mathematik & 27 \\
...
\makebox[\textwidth][c]{%
  ...
  \begin{tabular}{@{}p{4.4cm}@{\qquad}r@{\qquad}p{7.2cm}@{}}
    ...
    Mathecamp & 12.110 \texteuro & 11.400 \texteuro{} Eigenbeteiligung bereits
    abgezogen \\
    \bottomrule
    \textbf{Summe} & 17.010 \texteuro \\
    \bottomrule
  \end{tabular}%
}
...
mathematisches Sommercamp. Dabei ermöglichten wir 88~Teilnehmerinnen
...
Klassenstufen~4 bis~13 offen, auch solchen, die unsere anderen Angebote bisher
...
Im neuen Jahr wird das Mathecamp im gleichen Rahmen wie in diesem Jahr stattfinden. Die gute Erreichbarkeit von Augsburg aus, die Verfügbarkeit von ausreichend vielen
...
Als einziges Projekt können wir das Mathecamp nicht kostenlos anbieten. Die pro Teilnehmerin entstehenden Kosten von etwa 235~\texteuro{} möchten wir nicht in voller Höhe als Eigenbeitrag verlangen. Es ist uns bei allen unseren Angeboten sehr wichtig, dass für die
...
Um das Mathecamp~2015 wie geplant
...
Dritter angewiesen. Ohne Unterstützung müssten wir die Kosten für das Camp
vollständig auf die Teilnehmerinnen umlegen und könnten das Camp daher nur zu
einem hohen Eigenbeitrag von etwa 235~\texteuro{} anbieten.
...
\makebox[\textwidth][c]{%
  ...
  \begin{tabular}{@{}p{4.6cm}@{\qquad}r@{\qquad}p{7.1cm}@{}}
    \toprule
    \multicolumn{3}{@{}l@{}}{\textbf{Budget für das Mathecamp vom 22.--28. August 2015 (siebentägig)}} \\
    \toprule
    Unterkunft mit Verpflegung & 22.080 \texteuro & 30 \texteuro{} pro Nacht und
    Person zzgl. 12 \texteuro{} Mittagessen am letzten Tag (100 Schülerinnen und 15 Betreuerinnen) \\
    An- und Abreise & 300 \texteuro & Busunternehmen \\
    Versicherung & 130 \texteuro \\
    Sonstiges & 1.000 \texteuro & Workshop-Materialien,
    Zwischenmahlzeiten, Freizeitaktivitäten, Benzinkosten eines Autos vor Ort,
    diverse kleinere Posten \\
    Eigenbeteiligung & $-$11.400 \texteuro & 120 \texteuro{} pro Schülerin
    (abzüglich Zuschüsse für materiell schlechter gestellte Familien) \\
    \bottomrule
    \textbf{Summe} & 12.110 \texteuro \\
    \bottomrule
  \end{tabular}%
}
