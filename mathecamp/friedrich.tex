...
geringe Kosten. Diese deckten wir im Schuljahr~2014/2015 durch eine interne
...
verfügbare MINT-Mittel (1000 \texteuro).
...
\makebox[\textwidth][c]{%
  ...
  \begin{tabular}{@{}p{4.8cm}@{\qquad}r@{\qquad}p{6.9cm}@{}}
    ...
    Mathematikolympiade & 1.500 \texteuro \\
    Abschlussveranstaltung & 700 \texteuro & Verpflegung, Preise \\
    Mathecamp & 21.000 \texteuro & abzüglich 5.900 \texteuro{} Eigenbeteiligung \\
    \bottomrule
    \textbf{Summe} & 20.000 \texteuro \\
    \bottomrule
  \end{tabular}%
}
...
Körpern und den magischen "`Hexaflexagons"' aus Papier auf große und anhaltende Begeisterung. Natürlich gab auch obligatorische Highlights wie eine gemeinsame
Wanderung mit Geländespielen, einer Nachtwanderung, dem "`bunten Abend"' und dem gemeinsamen Singen. XXXEntsubstituieren XXXPapierflieger
...
Veranstaltung ist und das Mathecamp erstmalig stattfand. Ausgehend von den sehr positiven Rückmeldungen sowohl der Teilnehmerinnen, die am Ende des Camps an einer Evaluation
...
auch ihrer Eltern soll die Dauer jedoch von fünf auf sieben Tage verlängert werden. Wir hoffen über ausreichend finanzielle Mittel zu verfügen, um nach Möglichkeit allen
...
UntenXXX und auf der nächsten Seite sind in tabellarischer Form unsere Finanzierung des diesjährigen Mathecamps und die geplante Kostenkalkulation für das nächstjährige Mathecamp aufgeführt.
...
\makebox[\textwidth][c]{%
  ...
  \begin{tabular}{@{}p{4.8cm}@{\qquad}r@{\qquad}p{6.9cm}@{}}
    ...
    \toprule
    Unterkunft mit Verpflegung & 12.838 \texteuro & 30 \texteuro{} pro Nacht und
...
\makebox[\textwidth][c]{%
  ...
  \begin{tabular}{@{}p{4.8cm}@{\qquad}r@{\qquad}p{6.9cm}@{}}
    \toprule
    \multicolumn{3}{@{}l@{}}{\textbf{Geplantes Budget für das Mathecamp 2015 (siebentägig)}} \\
    \toprule
    ...
    Zwischenmahlzeiten, Freizeitaktivitäten, Benzinkosten eines Autos vor Ort,
    diverse kleinere Posten \\
    Eigenbeteiligung & $-$5.900 \texteuro & 70 \texteuro{} pro Schülerin
    (abzüglich Zuschüsse für einkommensschwache Familien) \\
    \bottomrule
    \textbf{Summe} & 15.400 \texteuro \\
    \bottomrule
  \end{tabular}%
}

XXX Tolles Schlusswort
